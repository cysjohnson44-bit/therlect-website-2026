...
const translations: Record<Language, Record<string, string>> = {
  ...
  en: {
    ...
    'company_description': 'Therlect, with over 20 years of professional thermal management expertise, is committed to providing theoretical analysis to market application for global customers.',
